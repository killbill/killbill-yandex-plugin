CREATE TABLE `yandex_payment_methods` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `kb_account_id` varchar(255) NOT NULL,
  `kb_payment_method_id` varchar(255) DEFAULT NULL,
  `yandex_token` varchar(255) DEFAULT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `index_yandex_payment_methods_on_kb_account_id` (`kb_account_id`),
  KEY `index_yandex_payment_methods_on_kb_payment_method_id` (`kb_payment_method_id`)
) ENGINE=InnoDB CHARACTER SET utf8 COLLATE utf8_bin;

CREATE TABLE `yandex_transactions` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `updated_at` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `index_yandex_transactions_on_kb_payment_id` (`kb_payment_id`)
) ENGINE=InnoDB CHARACTER SET utf8 COLLATE utf8_bin;

CREATE TABLE `yandex_responses` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `api_call` varchar(255) NOT NULL,
